...
import { DEFAULT_CART_DROPDOWN_FIELDS } from "@modules/common/components/cart"
import ProductOptionSelect from "@modules/products/components/product-option-select"
...
const ProductActions = memo(function ProductActions({
  ...
  const countryCode = getCountryCodeFromPath(pathname) || "dk"
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <div className="flex items-center gap-x-4">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center border border-gray-300 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed rounded-base"
              type="button"
            >
              -
            </button>
