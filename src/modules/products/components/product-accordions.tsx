...
const defaultItems: AccordionItem[] = [
  {
    ...
    content:
      "High-quality athleisure essential crafted for all-day comfort and style.",
  },
  {
    id: "fit",
    title: "Fit & Size",
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>
          <strong>Care:</strong> Machine wash cold, gentle cycle. Tumble dry
          low. Do not bleach or iron.
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p>
          <strong>Returns:</strong> 30-day returns for unworn items with tags
          attached. Free returns on all orders.
        </p>
      </div>
    ),
  },
