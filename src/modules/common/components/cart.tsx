...
import { Price } from "@modules/common/components/ui/price"
import { Thumbnail } from "@modules/common/components/ui/thumbnail"
import {
  useCart,
  useDeleteLineItem,
  useUpdateLineItem,
...
export const CartEmpty = () => {
  ...
  return (
    <div className="text-center py-16 flex flex-col items-center justify-center gap-4">
      ...
      <Link href={`/${countryCode || "us"}/store`}>
      ...
      <DrawerContent className="flex flex-col">
        ...
        {(!cart || itemCount === 0) && (
          <div className="flex flex-col items-center justify-center flex-1 p-6">
            ...
            <Link href={`/${countryCode || "us"}/store`} onClick={closeCart}>
        ...
        {cart && itemCount > 0 && (
          <>
            ...
            <DrawerFooter>
              ...
              <Link href={`/${countryCode || "us"}/cart`} onClick={closeCart}>
