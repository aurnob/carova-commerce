...
const createDomainKeys = (domain: string) => ({
  ...
  detail: (id: string, ...params: unknown[]) =>
    [domain, "detail", id, ...params] as const,
...
export const queryKeys = {
  ...
  payments: {
    ...
    forCart: (cartId: string) =>
      createDynamicKey("payments", "forCart", cartId),
    sessions: (regionId?: string) =>
      createDynamicKey("payments", "sessions", regionId),
  ...
  shipping: {
    ...
    forCart: (cartId: string) =>
      createDynamicKey("shipping", "forCart", cartId),
